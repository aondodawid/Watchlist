...
let renderHTML = "";
fetch("http://www.omdbapi.com/?apikey=71aa02e0&s=blade+runner")
  .then((response) => response.json())
  .then((data) => {
    console.log(data);
    console.log(data.Search[0].imdbID);
    data.Search.forEach((movie) => {
      console.log(`http://www.omdbapi.com/?apikey=71aa02e0&i=${movie.imdbID}`);
    ...
    // console.log(data.Ratings[0].Value.substring(0, 3));
  });
